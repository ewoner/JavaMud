 ...
 */
public class Make_Rooms_CSV {

    static File dir = new File("data/regions/");
    ...
    private static int saveFile(File file) {
        ...
        try {
            ...
            while (reader.ready()) {
                ...
                temp = reader.readLine();//chews up [databank]
            ...
            Logger.getLogger(Make_Rooms_CSV.class.getName()).log(Level.SEVERE, null, ex);
            return 1;
        }
        writer.close();
        try {
